 ...
 *  - burn: token2022Payment 50k $BRIX + solPayment 0.08 SOL
 *  - sol:  solFixedFee 0.16 + solPayment 0.08 = 0.24 SOL total
...
function parseError(msg: string, group?: "burn" | "sol"): string {
  ...
  if (m.includes("mintended") || m.includes("after end date"))     return "Phase F2 has ended.";
...
export default function MintButtonF2() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
      ...
      <div style={{ fontSize: ".6rem", color: "#888870", fontFamily: "var(--font-mono)", letterSpacing: ".1em", textAlign: "center", padding: "4px 0" }}>F2 — CHOOSE ACCESS METHOD</div>
