...
const zh: Dict = {
  ...
  faq: [
    ...
    { q: "团队如何获利？",
      a: "不靠交易税：创作者分成进入合约，一半销毁 $BRIX，一半用于 Top Burners 奖金。不靠铸造：团队没有免费的 Trixster。只有 1% 供应量的开发者储备，上线时像所有人一样从曲线买入，照常缴税，钱包公开声明。项目好，团队和所有持有者一样获利；项目不好，也一样亏损。" },
